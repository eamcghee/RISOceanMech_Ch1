...
x_trap = [2187.78531425016, 2187.78531425016, 1890.98630989421, 2004.65401369011]; % West Corridor v2
y_trap = [1032.19228375856, 2219.38830118233, 2124.66521468575, 1051.13690105787]; % West Corridor v2

%x_trap = [1181.04309165527, 947.149794801642, 992.129274965800, 1220.02530779754]; %West Corridor
%y_trap = [950.316689466484, 944.319425444596, 1849.90629274966, 1855.90355677155]; %West Corridor
...
for k = 1:length(image_files)
    ...
    fprintf('%s: Percent sea ice in west corridor (by pixels): %.2f%%\n', filename, perc_non_black);
...
% Save results to CSV
writetable(T, '/Users/em/PROJECTS/SeaIce/SeaIceCorridor_Apr25/WestCorr_nonblack_pixel_counts_multday3_2016_Oct1toJan1_v2.csv'); %Jan1toApr1

%% add Time_UTC column to csv

% Read the CSV file
T = readtable('/Users/em/PROJECTS/SeaIce/SeaIceCorridor_Apr25/WestCorr_nonblack_pixel_counts_multday3_2016_Oct1toJan1_v2.csv');
...
writetable(T, '/Users/em/PROJECTS/SeaIce/SeaIceCorridor_Apr25/WestCorr_nonblack_pixel_counts_multday_2016_Oct1toJan1_new_v2.csv');