...
% img = imread('/Users/em/PROJECTS/SeaIce/IMGS/2016_Jan1toApr1_v2/snapshot-2016-03-01T00_00_00Z.jpg');  % Replace with your image path
% imshow(img);
...
x_trap = [1786.79091474798, 2159.36838830118, 2206.72993154947, 1780.47604231487]; % near-front v2
y_trap = [874.320472930927, 931.154324828873, 1041.66459240821, 997.460485376477]; % near-front v2

% Define trapezoid coordinates (in pixels)
%x_trap = [785.750000000000, 707.750000000000, 1211.75000000000, 1175.75000000000]; 
%y_trap = [860.750000000000, 1043.75000000000, 1127.75000000000, 941.750000000000];
...
for k = 1:length(image_files)
    ...
    fprintf('%s: Percent sea ice in near-front corridor (by pixels): %.2f%%\n', filename, perc_non_black);
...
% Save results to CSV
writetable(T, '/Users/em/PROJECTS/SeaIce/SeaIceCorridor_Apr25/NearShelfNearStation_nonblack_pixel_counts_multday3_2016_Oct1toJan1_v2.csv');

%% add Time_UTC column to csv

% Read the CSV file
T = readtable('/Users/em/PROJECTS/SeaIce/SeaIceCorridor_Apr25/NearShelfNearStation_nonblack_pixel_counts_multday3_2016_Oct1toJan1_v2.csv');
...
writetable(T, '/Users/em/PROJECTS/SeaIce/SeaIceCorridor_Apr25/NearShelfNearStation_nonblack_pixel_counts_multday_2016_Oct1toJan1_new_v2.csv');
